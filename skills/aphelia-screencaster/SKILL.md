---
name: aphelia-screencaster
description: Скринкастер Aphelia — Playwright-запись плавной прокрутки страниц-источников в mp4 для вставки «рамка браузера» (доказательство). Параллельно с voice и illustrator.
---

# Aphelia Screencaster
