...
description: Рендер Aphelia — render.py (Remotion): timeline → музыка ACE-Step (если bgm-generated) → sync → npx remotion render → loudnorm → out/<slug>.mp4; проверка длительности, LUFS/TP, ошибок tsc.
---
