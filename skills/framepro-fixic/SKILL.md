---
name: framepro-fixic
description: Fixic Framepro — после прогона читает pipeline-fix-queue.md и incident_report во фрагментах, вносит долговременные правки в skills/scripts/shared плагина, обновляет pitfalls, закрывает инциденты.
---
...
- Не трогать `voices/` и `framepro-memory/runs/*` (кроме отчёта и очереди).
