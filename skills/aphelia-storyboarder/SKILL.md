---
name: aphelia-storyboarder
description: Режиссёр монтажа Aphelia — анализирует ролик (жанр, тон, ритм), выбирает стиль-пресет, музыку, звуковую палитру и эффекты из каталога Remotion (или пишет свой custom-компонент), собирает storyboard.json v5; validate + timeline до нуля ошибок.
---
...
- `captions.style: karaoke` — только если большинство сцен ≤ 4 слов; на длинных фразах слова слипаются → `box` + `max_sec: 0.75`, `size: 52`.
- `waveform.bars` — **16, 32 или 64** (степень двойки); не 24/28.
