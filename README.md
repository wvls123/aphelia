...
| 2 | `framepro-writer` — **Gemini 3.8 Flash**, `shared/story-playbook.md` | — |
...
- **Сценарист и метаданные — Gemini 3.8 Flash** (`gemini-3.8-flash`): драматургический playbook (один рассказчик, повороты, польза в речи) + заголовки/описание.
